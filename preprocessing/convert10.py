...
feature_names = ['b2c_c2c', 'shipment_method_id', 'shipping_fee', 'carrier_min_estimate', 'carrier_max_estimate', 'category_id', 'item_price', 'quantity', 'weight', 'distance', 'month', 'day', 'weekday', 'hour', 'is_holiday', 'near_holiday_7', 'near_holiday_3']
